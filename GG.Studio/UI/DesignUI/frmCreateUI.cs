...
namespace GG.Studio
{
    public partial class frmCreateUI : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void smt_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("Không có dữ liệu thiết kế để lưu", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }

        private void SaveToJson(ControlCollection control)
        {
            var obj = ConvertListToJson.GetValueJsonForList(control);
